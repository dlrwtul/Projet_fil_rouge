...
class getApiPlatform_Listener_View_WriteService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['api_platform.listener.view.write'] = new \ApiPlatform\Core\EventListener\WriteListener(new \ApiPlatform\Core\Bridge\Symfony\Bundle\DataPersister\TraceableChainDataPersister(new \ApiPlatform\Core\DataPersister\ChainDataPersister(new RewindableGenerator(function () use ($container) {
            yield 0 => ($container->privates['App\\DataPersister\\CommandeDataPersister'] ?? $container->load('getCommandeDataPersisterService'));
            yield 1 => ($container->privates['App\\DataPersister\\LivraisonDataPersister'] ?? $container->load('getLivraisonDataPersisterService'));
            yield 2 => ($container->privates['App\\DataPersister\\OthersDataPersister'] ?? $container->load('getOthersDataPersisterService'));
            yield 3 => ($container->privates['App\\DataPersister\\ProductDataPersister'] ?? $container->load('getProductDataPersisterService'));
            yield 4 => ($container->privates['api_platform.doctrine.orm.data_persister'] ?? $container->load('getApiPlatform_Doctrine_Orm_DataPersisterService'));
        }, 5))), ($container->privates['api_platform.iri_converter'] ?? $container->getApiPlatform_IriConverterService()), ($container->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? $container->getApiPlatform_Metadata_Resource_MetadataFactory_CachedService()), ($container->privates['api_platform.resource_class_resolver'] ?? $container->getApiPlatform_ResourceClassResolverService()));
    }
}
