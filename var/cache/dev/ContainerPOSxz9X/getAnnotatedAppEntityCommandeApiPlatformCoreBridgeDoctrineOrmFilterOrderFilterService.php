 ...
 */
class getAnnotatedAppEntityCommandeApiPlatformCoreBridgeDoctrineOrmFilterOrderFilterService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'annotated_app_entity_commande_api_platform_core_bridge_doctrine_orm_filter_order_filter' shared autowired service.
     *
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['annotated_app_entity_commande_api_platform_core_bridge_doctrine_orm_filter_order_filter'] = new \ApiPlatform\Core\Bridge\Doctrine\Orm\Filter\OrderFilter(($container->services['doctrine'] ?? $container->getDoctrineService()), NULL, 'order', ($container->privates['logger'] ?? ($container->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())), ['id' => NULL, 'createdAt' => NULL], ($container->privates['serializer.name_converter.metadata_aware'] ?? $container->getSerializer_NameConverter_MetadataAwareService()));
    }
}
